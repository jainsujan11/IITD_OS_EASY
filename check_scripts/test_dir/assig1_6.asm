 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 455:	57                   	push   %edi
 456:	56                   	push   %esi
 457:	e8 37 fe ff ff       	call   293 <write>
 ...
 4ae:	e8 e0 fd ff ff       	call   293 <write>
        putc(fd, c);
 ...
 4bf:	57                   	push   %edi
 4c0:	56                   	push   %esi
 4c1:	e8 cd fd ff ff       	call   293 <write>
        putc(fd, c);
 ...
 56c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 56f:	e8 1f fd ff ff       	call   293 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6a3:	e8 53 fc ff ff       	call   2fb <sbrk>
  if(p == (char*)-1)
