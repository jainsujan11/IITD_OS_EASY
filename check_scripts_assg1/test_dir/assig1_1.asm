...
main(void)
{
  ...
  11:	e8 2d 03 00 00       	call   343 <toggle>
  ...
  36:	e8 68 02 00 00       	call   2a3 <exit>
		print_count();
  3b:	e8 0b 03 00 00       	call   34b <print_count>
		toggle();		
  40:	e8 fe 02 00 00       	call   343 <toggle>
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 485:	57                   	push   %edi
 486:	56                   	push   %esi
 487:	e8 37 fe ff ff       	call   2c3 <write>
 ...
 4de:	e8 e0 fd ff ff       	call   2c3 <write>
        putc(fd, c);
 ...
 4ef:	57                   	push   %edi
 4f0:	56                   	push   %esi
 4f1:	e8 cd fd ff ff       	call   2c3 <write>
        putc(fd, c);
 ...
 59c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 59f:	e8 1f fd ff ff       	call   2c3 <write>
        ap++;
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 7b 07 00 00       	mov    $0x77b,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6d3:	e8 53 fc ff ff       	call   32b <sbrk>
  if(p == (char*)-1)
